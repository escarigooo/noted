...
CREATE TABLE invoices (
    ...
    company_name VARCHAR(100) DEFAULT 'Noted Demo Store',
    company_vat VARCHAR(20) DEFAULT 'PT123456789',
    company_address VARCHAR(255) DEFAULT 'Example Street 1, Example City',
    company_phone VARCHAR(20) DEFAULT '+351 000 000 000',
    company_email VARCHAR(100) DEFAULT 'billing@example.com',
